        ...
        <div className="flex-1 space-y-8 overflow-y-auto p-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Decrivez les caracteristiques du produit..."
          ...
          <div className="space-y-3">
            <SwitchField
              ...
              description="Activer pour autoriser les achats et la gestion du stock"
            />
            <SwitchField
              id="inView"
              checked={form.inView}
              onChange={(next) => setForm({ ...form, inView: next })}
              label="Visibilite de la boutique"
              description="Rendre le produit visible dans le catalogue public"
            />
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {adding ? (
                ...
                editState.mode === "create" ? "Creer un produit" : "Enregistrer les modifications"
              )}
            </button>
            <button
              onClick={() => {
