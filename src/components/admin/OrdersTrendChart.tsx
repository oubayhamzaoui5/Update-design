        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-4 ml-2 border-l pl-4 border-slate-200">
            ...
            <button 
              ...
              title={showDelivered ? "Masquer les livrees" : "Afficher livrees"}
            >
            ...
            <button 
              ...
              title={showReturned ? "Masquer les remboursees" : "Afficher remboursees"}
            >
              <div className="text-right">
      ...
      <div className="h-72 w-full relative">
        {chartError && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 rounded-xl" style={{ background: '#FEF2F2' }}>
            <span className="text-sm font-medium" style={{ color: '#991B1B' }}>Echec du chargement du graphique.</span>
