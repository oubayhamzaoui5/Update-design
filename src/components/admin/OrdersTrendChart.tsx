      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500">
            {viewMode === 'month' ? `Vue quotidienne de ${MONTHS_FR[selectedMonth]}` : `Vue mensuelle de l'année ${selectedYear}`}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-4 ml-2 border-l pl-4 border-slate-200">
            ...
            <button 
              ...
              title={showDelivered ? "Masquer les livraisons" : "Afficher les livraisons"}
            >
              <div className="text-right">
                <p className="text-[10px] text-green-600 uppercase font-black tracking-wider">Livrées</p>
            ...
            <button 
              ...
              title={showReturned ? "Masquer les retours" : "Afficher les retours"}
            >
              <div className="text-right">
                <p className="text-[10px] text-red-600 uppercase font-black tracking-wider">Retours</p>
