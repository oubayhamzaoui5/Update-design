    ...
    <aside className="hidden w-60 border-r border-foreground/10 bg-background md:flex md:flex-col">
      <div className="flex items-center justify-center px-6 py-4">
        <Link href="/" className="flex items-center justify-center">
          <div className="relative h-20 w-20">
            <Image src="/logow.png" alt="Logo" width={160} height={160} className="object-cover" />
          </div>
        </Link>
      </div>
      ...
      <div className="px-3 pb-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-base font-medium text-foreground transition-colors hover:bg-foreground/15"
        >
          <LogOut size={20} />
          Deconnexion
        </button>
