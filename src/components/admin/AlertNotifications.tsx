...
export default function AlertNotifications() {
  ...
  const alerts: (Alert & { type: 'danger' | 'warning' | 'info' })[] = [
    {
      type: 'danger',
      message: `${counts?.outOfStock || 0} produits sont en rupture de stock`,
      link: '/admin/inventory',
      linkText: 'Gérer le stock'
    },
    {
      type: 'warning',
      message: `${counts?.lowStock || 0} produits ont un stock faible`,
      link: '/admin/inventory',
      linkText: 'Gérer le stock'
    },
    {
      type: 'info',
      message: `${counts?.pendingOrders || 0} commandes sont en attente`,
      link: '/admin/orders',
