...
export default function ChartsRow() {
  ...
  // Helper for consistent Tunisian Dinar formatting
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center gap-2 mb-4">
          <h3 className="text-slate-700 font-semibold">Ventes Hebdomadaires</h3>
        </div>
        <div className="flex items-end justify-between gap-6">
          <div className="flex flex-col justify-end pb-2">
            <p className="text-3xl font-bold text-slate-800 mb-1">
              {formatDT(data.weeklySalesTotal)} <span className="text-lg font-medium text-slate-500">DT</span>
            </p>
          ...
          <div className="relative flex items-end gap-1.5 h-24">
            {hoveredDay !== null && (
              <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap pointer-events-none z-10 shadow-lg">
                ...
                {dynamicDays[hoveredDay]}: {formatDT(data.weeklySalesData[hoveredDay])} DT
              </div>
            )}
      ...
      {/* Top Categories */}
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h3 className="text-slate-700 font-semibold mb-6">Top Catégories</h3>
