      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 lg:flex-row lg:gap-16 lg:px-10">
        ...
        >
          <div className="relative h-72 w-72 md:h-[400px] md:w-[400px] lg:h-[460px] lg:w-[460px]">
            <div className="absolute inset-0 rounded-full blur-[80px] opacity-20" style={{ background: "#C4A23E" }} />
            <Image
              src="/strawberry.png"
        ...
        >
          <span
            ...
            style={{ background: "rgba(196,162,62,0.1)", color: "#C4A23E" }}
          >
            Signature Flavor
          </span>
          ...
          <div className="mb-8 flex flex-wrap gap-2">
            {["Real Strawberries", "0g Sugar", "Ready to Eat", "22g Protein/Serving"].map((tag) => (
              <span
                ...
                style={{ background: "rgba(196,162,62,0.08)", color: "#C4A23E" }}
              >
                {tag}
              </span>
            ))}
