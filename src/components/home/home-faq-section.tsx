...
const faqItems = [
  {
    question: 'What are the main ingredients in Update Design?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Update Design stays fresh for up to 7 days when refrigerated. We recommend consuming within 5 days of opening for optimal taste and texture.',
  },
  {
  ...
  {
    question: 'Is Update Design suitable for vegans?',
    answer:
