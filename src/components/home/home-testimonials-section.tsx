...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    quote:
      "I've tried every protein pudding on the market — Update Design is on another level. The texture is perfect and I actually look forward to my post-workout snack now.",
  },
  {
    id: 2,
    name: "James T.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "Clean label, real ingredients, and the chia gel keeps my clients full for hours. I recommend Update Design to everyone who asks me about healthy snacking.",
  },
  {
    id: 4,
    name: "Daniel R.",
