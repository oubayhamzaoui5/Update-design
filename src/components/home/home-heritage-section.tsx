export default function HomeHeritageSection() {
  return (
    <section id="about" className="bg-white py-10 md:py-16 lg:py-18">
...
Chez <span className="font-bold text-accent"> UPDATE DESIGN</span>, nous sommes fiers d’être un spécialiste de référence en Tunisie dans le domaine des panneaux muraux haut de gamme. Notre objectif est simple : permettre à chacun de rénover facilement son salon, sa chambre, sa cuisine et même sa salle de bain. Grâce à notre large gamme de <span className="font-bold">panneaux muraux effet marbre en PVC et profiles muraux effet bois en PVC</span> , nous proposons des solutions modernes, esthétiques et accessibles.          </p>
          <p className="mb-6 text-sm leading-relaxed text-slate-600 lg:text-lg">
Avec <span className="font-bold">UPDATE DESIGN</span>, chacun peut donner un nouveau souffle à ses murs tout en maîtrisant son budget. Nos panneaux sont conçus pour être posés directement sur les supports existants, sans gros travaux ni interventions complexes. Résistants à l’humidité, élégants et durables, ils représentent la solution idéale pour moderniser rapidement et à moindre coût toutes les pièces de votre intérieur en Tunisie.          </p>
