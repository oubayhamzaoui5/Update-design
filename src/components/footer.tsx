...
const columns = [
  {
    heading: "Catalogue",
    links: [
      { label: "Profil mural effet bois", href: "/profil-mural-effet-bois" },
      { label: "Panneaux effet marbre", href: "/panneaux-effet-marbre" },
      { label: "PVC effet bois exterieur", href: "/pvc-effet-bois-exterieur" },
      { label: "Gazon artificiel", href: "/gazon-artificiel" },
      { label: "Moulures decoratives", href: "/moulures-decoratives" },
      { label: "Lampes LED", href: "/lampes" },
      { label: "Store bras invisible", href: "/store-bras" },
      { label: "Parasols professionnels", href: "/parasols" },
...
export default function Footer() {
  return (
    <footer aria-label="Site footer" style={{ background: CREAM, borderTop: `1px solid rgba(196,162,62,0.2)` }}>
      <div className="mx-auto max-w-[1400px] px-6 pb-10 pt-16 md:px-10">
        <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p style={{ fontFamily: BODY, fontSize: "0.82rem", color: `rgba(28,26,20,0.5)`, letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 500, marginTop: 10 }}>
              Decoration interieure & exterieure - Tunisie
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#" aria-label="Instagram" className="flex items-center justify-center transition-all hover:opacity-70" style={{ width: 38, height: 38, border: `1px solid rgba(196,162,62,0.35)`, color: DARK, flexShrink: 0 }}>
            ...
            <a href="#" aria-label="Facebook" className="flex items-center justify-center transition-all hover:opacity-70" style={{ width: 38, height: 38, border: `1px solid rgba(196,162,62,0.35)`, color: DARK, flexShrink: 0 }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mb-14 grid grid-cols-2 gap-x-6 gap-y-10 md:grid-cols-3">
            ...
            <div key={heading}>
              ...
              <nav className="flex flex-col gap-3">
                {links.map(({ label, href }) => (
                  <Link key={label} href={href} style={{ fontFamily: BODY, fontSize: "0.82rem", fontWeight: 600, color: `rgba(28,26,20,0.65)`, letterSpacing: "0.02em" }} className="transition-colors hover:text-[#C4A23E]">
                    {label}
                  </Link>
                ))}
              </nav>
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row" style={{ borderTop: `1px solid rgba(196,162,62,0.15)`, paddingTop: 28 }}>
          <p style={{ fontFamily: BODY, fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: `rgba(28,26,20,0.65)`, fontWeight: 700 }}>
            &copy; 2026 Update Design. Tous droits reserves.
          </p>
          <div className="flex items-center gap-3">
