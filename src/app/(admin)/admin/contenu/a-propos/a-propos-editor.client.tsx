    ...
    <div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-2">
          <Input value={value} onChange={onChange} placeholder="/a-propos/image.jpg" />
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-[220px_1fr] items-start">
          ...
          <div className="rounded-2xl p-6" style={S.card}>
            ...
            {section === 'hero' && (
              <>
                <SectionTitle icon={LucideImage} title="Hero" description="Section plein-écran en haut de la page /a-propos." />
                <div className="space-y-4">
                  ...
                  <Row>
                    ...
                    <Field label="Lien CTA"><Input value={data.hero.ctaHref} onChange={v => patchField('hero', 'ctaHref', v)} placeholder="/boutique" /></Field>
                  </Row>
                </div>
              </>
            )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl p-4 space-y-3" style={{ background: '#F9FAFB', border: '1px solid #F0F2F5' }}>
                    ...
                    <Row>
                      ...
                      <Field label="Lien"><Input value={data.cta.primaryHref} onChange={v => patchField('cta', 'primaryHref', v)} placeholder="/boutique" /></Field>
                    </Row>
                  </div>
                  <div className="rounded-xl p-4 space-y-3" style={{ background: '#F9FAFB', border: '1px solid #F0F2F5' }}>
