...
export default function KeysClient({
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.error) {
          ...
          setGoogleStatus({ type: 'success', msg: 'Cles Google OAuth enregistrees et chiffrees avec succes.' })
          setMaskedGoogleId(clientId.length > 12 ? `${clientId.slice(0, 8)}ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢${clientId.slice(-4)}` : 'ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢')
        }
      } else {
        setGoogleStatus({ type: 'error', msg: result.error ?? "Echec de l'enregistrement des cles." })
      }
    } catch {
      setGoogleStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
  ...
  async function handleGoogleDelete() {
    ...
    try {
      ...
      if (result.success) {
        ...
        setGoogleStatus({ type: 'success', msg: 'Cles Google OAuth supprimees.' })
      } else {
        setGoogleStatus({ type: 'error', msg: result.error ?? 'Echec de la suppression des cles.' })
      }
    } catch {
      setGoogleStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
  ...
  async function handleStripeSave(e: React.FormEvent) {
    ...
    try {
      ...
      if (result.success) {
        ...
        setMaskedStripePk(pk.length > 12 ? `${pk.slice(0, 8)}ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢${pk.slice(-4)}` : 'ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢')
        setStripePk('')
        setStripeSk('')
        setStripeStatus({ type: 'success', msg: 'Cles Stripe enregistrees et chiffrees avec succes.' })
      } else {
        setStripeStatus({ type: 'error', msg: result.error ?? "Echec de l'enregistrement des cles Stripe." })
      }
    } catch {
      setStripeStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
  ...
  async function handleStripeDelete() {
    if (!confirm('Supprimer les cles Stripe ? Le paiement repassera en mode test.')) return
    setStripeStatus(null)
    ...
    try {
      ...
      if (result.success) {
        ...
        setStripeStatus({ type: 'success', msg: 'Cles Stripe supprimees.' })
      } else {
        setStripeStatus({ type: 'error', msg: result.error ?? 'Echec de la suppression des cles Stripe.' })
      }
    } catch {
      setStripeStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
  ...
  async function handleMetaSave(e: React.FormEvent) {
    ...
    try {
      ...
      if (result.success) {
        ...
        setMaskedMetaId(id.length > 8 ? `${id.slice(0, 4)}ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢${id.slice(-4)}` : 'ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢')
        setMetaPixelId('')
        setMetaStatus({ type: 'success', msg: 'Meta Pixel ID saved successfully.' })
      } else {
        setMetaStatus({ type: 'error', msg: result.error ?? "Echec de l'enregistrement de l'ID Pixel." })
      }
    } catch {
      setMetaStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
      setMetaSaving(false)
    }
  }
  ...
  async function handleMetaDelete() {
    if (!confirm("Supprimer le Pixel Meta ? Le suivi des evenements s'arretera immediatement.")) return
    setMetaStatus(null)
    ...
    try {
      ...
      if (result.success) {
        ...
        setMetaStatus({ type: 'error', msg: result.error ?? 'Echec de la suppression du Pixel.' })
      }
    } catch {
      setMetaStatus({ type: 'error', msg: 'Une erreur inattendue est survenue.' })
    } finally {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm" style={{ color: '#6B7280' }}>
              Gerez les identifiants OAuth. Les cles sont chiffrees au repos et jamais exposees dans git.
            </p>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="flex items-center gap-2">
              {isGoogleConfigured ? (
                <>
                  ...
                  >
                    <Trash2 size={12} />
                    {googleDeleting ? 'Suppression...' : 'Supprimer'}
                  </button>
                </>
              ) : (
          ...
          <div className="px-6 py-5">
            ...
            <form onSubmit={handleGoogleSave} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="GOCSPX-ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                >
                  <Key size={14} />
                  {googleSaving ? 'Enregistrement...' : isGoogleConfigured ? 'Mettre a jour les cles' : 'Enregistrer et activer'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="rounded-b-2xl border-t border-slate-100 bg-slate-50 px-6 py-4">
            ...
            <ol className="mt-2 space-y-1 text-xs text-slate-400">
              <li>1. Go to Google Cloud Console ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ APIs &amp; Services ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Credentials</li>
              ...
              <li>4. Paste your Client ID and Client Secret above ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they will be encrypted before saving</li>
            </ol>
          </div>
        </div>
            ...
            <div className="flex items-center gap-2">
              {isStripeConfigured ? (
                <>
                  ...
                  >
                    <Trash2 size={12} />
                    {stripeDeleting ? 'Suppression...' : 'Supprimer'}
                  </button>
                </>
              ) : (
                <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-500">
            ...
            <form onSubmit={handleStripeSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={inputCls}
                  placeholder="pk_test_ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"
                  autoComplete="off"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputCls} pr-10`}
                    placeholder="sk_test_ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢"
                    autoComplete="new-password"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                >
                  <Key size={14} />
                  {stripeSaving ? 'Enregistrement...' : isStripeConfigured ? 'Mettre a jour les cles' : 'Enregistrer et activer'}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="flex items-center gap-2">
              {isMetaConfigured ? (
                <>
                  ...
                  >
                    <Trash2 size={12} />
                    {metaDeleting ? 'Suppression...' : 'Supprimer'}
                  </button>
                </>
              ) : (
                <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-500">
            ...
            <form onSubmit={handleMetaSave} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  autoComplete="off"
                />
                <p className="mt-1.5 text-xs text-slate-400">ID numerique trouve dans le Gestionnaire d'evenements Meta (10-20 chiffres).</p>
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                >
                  <ExternalLink size={12} />
                  Gestionnaire d'evenements Meta
                </a>
                ...
                >
                  <Key size={14} />
                  {metaSaving ? 'Enregistrement...' : isMetaConfigured ? 'Mettre a jour le Pixel' : 'Enregistrer et activer'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="rounded-b-2xl border-t border-slate-100 bg-slate-50 px-6 py-4">
            ...
            <ul className="mt-2 space-y-1 text-xs text-slate-400">
              <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ <strong className="text-slate-500">ViewContent</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â fires when a visitor opens a product page</li>
              <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ <strong className="text-slate-500">AddToCart</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â fires when a visitor clicks &quot;Add to cart&quot;</li>
            </ul>
          </div>
        </div>
