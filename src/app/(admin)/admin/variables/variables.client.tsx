    ...
    <div className="p-6 md:p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-slate-600">
          Gerez les couleurs et images utilisees dans vos produits
        </p>
      </div>
      ...
      <section className="mb-10">
        ...
        {filteredImages.length === 0 ? (
          <div className="rounded-lg border border-slate-200 bg-slate-50 py-12 text-center">
            ...
            <p className="text-sm text-slate-600">Aucune image trouvee</p>
          </div>
        ) : (
    ...
    <p className="w-full truncate text-sm font-medium text-slate-800 px-2">
      ...
      <section>
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-xl font-semibold text-slate-800">Couleurs</h2>
        ...
        {filteredColors.length === 0 ? (
          <div className="rounded-lg border border-slate-200 bg-slate-50 py-12 text-center">
            ...
            <p className="text-sm text-slate-600">Aucune couleur trouvee</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
