...
const categories = [
  {
    ...
    img: "/a-propos/about-interior.jpg",
    href: "/boutique/decoration-interieur",
  },
  {
    ...
    img: "/a-propos/about-exterior.jpg",
    href: "/boutique/decoration-exterieur",
  },
  {
    label: "Éclairage & Électricité",
    desc: "Tubes néon LED T8 haute performance pour un éclairage moderne, économique et élégant.",
    img: "/a-propos/about-lighting.jpg",
    href: "/boutique/articles-electricite",
  },
]
